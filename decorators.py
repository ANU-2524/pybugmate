...
def bugmate(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        try:
            ...
            # --- Smart Hints for Common Python Errors !!!
            hints = {
            ...
            log_error("Traceback (user line):")
            log_error(formatted_tb.strip())
            # raise ... Commented this , so that in terminal , do not get error. Just get pretty hint/error from code.
